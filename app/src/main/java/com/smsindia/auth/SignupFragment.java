    ...
    @Override public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(view -> {
            ...
            mAuth.createUserWithEmailAndPassword(email, pass)
                                ...
                                .addOnSuccessListener(query -> {
                                    if (!query.isEmpty()) {
                                        ...
                                        db.collection("users").document(refUid)
                                          ...
                                          .addOnSuccessListener(__ -> Toast.makeText(requireContext(), "Referral bonus credited", Toast.LENGTH_SHORT).show());
                                    }
                                });
                          }
                ...
                .addOnFailureListener(e -> Toast.makeText(requireContext(), "Signup failed: " + e.getMessage(), Toast.LENGTH_LONG).show());
        });
